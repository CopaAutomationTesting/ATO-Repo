...
/*	public static final int PNRNUM = 0;
	...
	public static String SelList = "";
	public static String SelList2 = "";
	...
	public void login(WebDriver driver, BFrameworkQueryObjects queryObjects) throws Exception{
		...
		try{
			...
			RETFLIGHTNUM = "";
			RETSEGMENT = "";
			SelList = "(//md-virtual-repeat-container[@aria-hidden='false']//li[1])[1]";
			SelList2 = "(//md-virtual-repeat-container[@aria-hidden='false']//li[1])[2]";
