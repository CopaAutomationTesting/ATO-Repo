...
public class FlightSearchPageObjects {
	...
	public static String PaxReductionXpath="//span[contains(text(),'Passenger Reduction Type')]/preceding::i[1]";
  ...
  //  public static String selectfirsttraverxpath="//div[contains(@id,'select_container') and contains(@class,'md-active')]//md-option[@aria-checked='false']";
    ...
    public static String phonetypeXpath="//div[@action='emergency-contact']/../div//md-select";
    public static String phonetypeXpathpAX="//md-select[@aria-label='Phone Type']";
    public static String selectfirstphonetypeXpath="//div[@aria-hidden='false']//md-option[div[text()='Agency Phone']]";
    public static String selectfirstphonetypeXpathPAX="//div[contains(@class,'md-active')]//md-option[div[text()='Agency Phone'] and @value=\"2\"]";

    public static String countrycodeselectXpath="//div[@action='emergency-contact']/../div//input[@name='countryCode']";
    public static String countrycodeselectXpathPAX="//span[@translate='pssgui.emergency.contact']/following::div//form//div[contains(@ng-if,'countryCode')]//input";
    public static String phonenumberxpath="//div[@action='emergency-contact']/..//input[@name='Phone Number']";
    public static String phonenumberxpathpaX="//span[@translate='pssgui.emergency.contact']/following::div//form//md-input-container//label[@translate=\"pssgui.phone.number\"]/following::input";
