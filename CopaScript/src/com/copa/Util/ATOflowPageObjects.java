...
public class ATOflowPageObjects {
	 ...
	 public static String BaggageXpath="//i[@class='icon-baggage']/../span";
	...
	// public static String AltFgtSelButton= "(//button[contains(@ng-click,'flightResult.selectedFlights')])[1]";
	 ...
	 public static String OversoldTab= "//div[div[contains(text(),'Oversold')]]/div/div";
	 public static String Compensate= "//button[@translate='pssgui.compensate']";
}
